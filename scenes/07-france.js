...
<defs>
  ...
  <linearGradient id="france-drop" x1="0" y1="0" x2="0" y2="1">
    <stop offset="0" stop-color="#4a3728" stop-opacity="0.36"/>
    <stop offset="1" stop-color="#4a3728" stop-opacity="0"/>
  </linearGradient>
  <linearGradient id="france-recess" x1="0" y1="0" x2="0" y2="1">
    <stop offset="0" stop-color="#171c19" stop-opacity="0.86"/>
    <stop offset="0.55" stop-color="#2b322c" stop-opacity="0.55"/>
    <stop offset="1" stop-color="#2b322c" stop-opacity="0.3"/>
  </linearGradient>
  ...
  <radialGradient id="france-shadow" cx="0.5" cy="0.5" r="0.5">
    <stop offset="0" stop-color="#6d543a" stop-opacity="0.38"/>
    <stop offset="0.52" stop-color="#6d543a" stop-opacity="0.17"/>
    <stop offset="1" stop-color="#6d543a" stop-opacity="0"/>
  </radialGradient>
  <radialGradient id="france-shadow-core" cx="0.5" cy="0.5" r="0.5">
    <stop offset="0" stop-color="#3d2b18" stop-opacity="0.6"/>
    <stop offset="0.5" stop-color="#3d2b18" stop-opacity="0.3"/>
    <stop offset="1" stop-color="#3d2b18" stop-opacity="0"/>
  </radialGradient>
...
<!-- ============ ZONE 1a: morning sky (sun upper-left, shadows fall down-right) ============ -->
<rect x="0" y="0" width="800" height="1200" fill="#efe0cd"/>
<rect x="0" y="0" width="800" height="690" fill="url(#france-sky)"/>
<circle cx="172" cy="146" r="214" fill="url(#france-glow-sun)"/>
<circle cx="172" cy="146" r="46" fill="#fff8ec" opacity="0.85"/>
<ellipse cx="404" cy="106" rx="112" ry="30" fill="url(#france-cloud)"/>
<ellipse cx="452" cy="92" rx="70" ry="22" fill="url(#france-cloud)"/>
<ellipse cx="690" cy="236" rx="116" ry="26" fill="url(#france-cloud)" opacity="0.55"/>

<g data-obj="hot-balloon" transform="translate(516,100)">
...
<!-- ============ ZONE 1b: misty Eiffel Tower + hazy far skyline ============ -->
...
<ellipse cx="70" cy="270" rx="34" ry="8" fill="url(#france-shadow-cool)"/>
...
<rect x="-10" y="373" width="320" height="11" fill="#fdf4e2" opacity="0.85"/>
...
<rect x="16" y="487" width="76" height="12" fill="url(#france-drop)"/>
<rect x="108" y="487" width="76" height="12" fill="url(#france-drop)"/>
<rect x="200" y="487" width="76" height="12" fill="url(#france-drop)"/>
<rect x="108" y="609" width="76" height="12" fill="url(#france-drop)"/>
<rect x="200" y="609" width="76" height="12" fill="url(#france-drop)"/>

<!-- ============ ZONE 2b: middle block ============ -->
...
<rect x="314" y="457" width="74" height="12" fill="url(#france-drop)"/>
<rect x="396" y="457" width="74" height="12" fill="url(#france-drop)"/>
<rect x="478" y="457" width="74" height="12" fill="url(#france-drop)"/>
...
<rect x="728" y="473" width="72" height="12" fill="url(#france-drop)"/>
<rect x="728" y="593" width="72" height="12" fill="url(#france-drop)"/>
...
<!-- ============ ZONE 1c: the kite, flown from the balcony rail ============ -->
<path d="M321 187 C302 258 272 342 243 445" stroke="#8a7f6a" stroke-width="1.6" fill="none" opacity="0.85"/>
<circle cx="243" cy="446" r="3" fill="#8a7f6a"/>
<g data-obj="paper-kite" transform="translate(300,120)">
...
<!-- ============ ZONE 1d: rooftop residents (chimney, ridge, roof deck) ============ -->
<ellipse cx="42" cy="210" rx="22" ry="5" fill="url(#france-shadow-core)" opacity="0.5"/>
<g data-obj="weather-vane" transform="translate(16,148)">
  ...
  <path d="M2 3 L36 10 L2 10 Z" fill="#a63d55"/>
  <circle cx="20" cy="23" r="4.5" fill="url(#france-sph-gold)"/>
  <path d="M6 25 l-5 5 M35 25 l5 5" stroke="#474454" stroke-width="3" fill="none"/>
</g>
<ellipse cx="238" cy="280" rx="40" ry="9" fill="url(#france-shadow)" opacity="0.7"/>
<ellipse cx="228" cy="279" rx="26" ry="5" fill="url(#france-shadow-core)"/>
<g data-obj="dovecote" transform="translate(197,214)">
...
<ellipse cx="400" cy="246" rx="36" ry="6" fill="url(#france-shadow-core)" opacity="0.55"/>
<g data-obj="roof-cat" transform="translate(360,200)">
...
<ellipse cx="486" cy="245" rx="24" ry="4" fill="url(#france-shadow-core)" opacity="0.5"/>
<g data-obj="swallow" transform="translate(452,208)">
...
<!-- ============ ZONE 2d: the balconies (upper row: floor at y478, rail 448-478) ============ -->
<ellipse cx="58" cy="479" rx="26" ry="6" fill="url(#france-shadow-core)"/>
<g data-obj="sill-cactus" transform="translate(34,419)">
...
<ellipse cx="234" cy="479" rx="30" ry="6" fill="url(#france-shadow-core)"/>
<g data-obj="book-stack" transform="translate(212,443)">
...
<!-- the dress is draped OVER the middle rail; a tea towel decoy shares the line -->
<g data-obj="laundry-dress" transform="translate(120,420)">
...
<path d="M30 450 v28 M58 450 v28 M122 450 v28 M170 450 v28 M214 450 v28 M242 450 v28 M266 450 v28" stroke="#3a3844" stroke-width="2" fill="none"/>
<path d="M118 442 q10 -6 22 -2 M150 440 q8 -5 16 -2" stroke="#6f6a5e" stroke-width="3" fill="none" stroke-linecap="round"/>
<path d="M60 446 q22 -6 30 4 l-4 26 q-14 4 -24 -2 Z" fill="#e9f0f2"/>
<path d="M60 446 q22 -6 30 4 l-1 7 q-14 -6 -28 -2 Z" fill="#ffffff" opacity="0.6"/>
<!-- lower row: floor at y600, rail 574-600 -->
...
<ellipse cx="242" cy="601" rx="24" ry="5" fill="url(#france-shadow-core)"/>
<g data-obj="wine-carafe" transform="translate(220,539)">
...
<ellipse cx="52" cy="600" rx="22" ry="10" fill="url(#france-sph-green)"/>
<circle cx="60" cy="592" r="6" fill="url(#france-sph-rose)"/>
<!-- birdcage hangs from the underside of the upper balcony -->
<path d="M147 487 v9" stroke="#8a7f6a" stroke-width="2" fill="none"/>
<ellipse cx="158" cy="552" rx="26" ry="6" fill="url(#france-shadow)" opacity="0.5"/>
<g data-obj="bird-cage" transform="translate(126,494)">
...
<!-- wall lamp bracketed to the corner pilaster -->
<ellipse cx="290" cy="556" rx="30" ry="8" fill="url(#france-shadow)" opacity="0.45"/>
<g data-obj="wall-lamp" transform="translate(268,486)">
...
<!-- letterbox screwed to the right block wall, with a house-number plate above -->
<rect x="702" y="556" width="34" height="22" rx="3" fill="url(#france-blue)"/>
<rect x="705" y="559" width="28" height="16" rx="2" fill="none" stroke="#e6dccb" stroke-width="2"/>
<ellipse cx="726" cy="660" rx="26" ry="7" fill="url(#france-shadow)" opacity="0.45"/>
<g data-obj="letter-box" transform="translate(700,600)">
...
<!-- ============ ZONE 3a: alley wall, its plane tree and its shelf ============ -->
...
<!-- wall shelf: dark under-shadow, body, lit front lip -->
<rect x="552" y="560" width="152" height="12" rx="3" fill="url(#france-wood)"/>
<rect x="552" y="560" width="152" height="4" rx="2" fill="#e0b98a"/>
<rect x="552" y="572" width="152" height="16" fill="url(#france-drop)"/>
<ellipse cx="590" cy="561" rx="28" ry="5" fill="url(#france-shadow-core)"/>
<g data-obj="coffee-mill" transform="translate(560,500)">
...
<ellipse cx="648" cy="561" rx="32" ry="5" fill="url(#france-shadow-core)"/>
<g data-obj="watering-can" transform="translate(618,508)">
...
<!-- herbs hung from a hook under the same shelf -->
<path d="M678 572 v4" stroke="#8a7f6a" stroke-width="2" fill="none"/>
<g data-obj="hang-herbs" transform="translate(660,574)">
...
<ellipse cx="592" cy="748" rx="16" ry="44" fill="url(#france-shadow)" opacity="0.5"/>
<rect x="580" y="730" width="17" height="212" fill="url(#france-wood)"/>
<rect x="580" y="730" width="6" height="212" fill="#d8a877" opacity="0.6"/>
<ellipse cx="592" cy="676" rx="58" ry="62" fill="url(#france-tree)"/>
<ellipse cx="566" cy="654" rx="36" ry="38" fill="#8fb87f" opacity="0.72"/>
<ellipse cx="616" cy="702" rx="32" ry="32" fill="#42603d" opacity="0.5"/>

<!-- ============ ZONE 4a: café ground floor with three lit windows ============ -->
...
<rect x="10" y="682" width="196" height="30" fill="url(#france-recess)"/>
<rect x="222" y="682" width="196" height="30" fill="url(#france-recess)"/>
<rect x="434" y="682" width="106" height="30" fill="url(#france-recess)"/>
<path d="M108 682 v206 M320 682 v206 M487 682 v206" stroke="#3a3540" stroke-width="6" fill="none"/>
<path d="M24 888 L76 700 L108 700 L56 888 Z M238 888 L290 700 L310 700 L258 888 Z" fill="#ffffff" opacity="0.1"/>

<!-- window 1: milliner's shelf — the beret among look-alike hats -->
<rect x="12" y="746" width="192" height="10" rx="3" fill="url(#france-wood)"/>
<rect x="12" y="746" width="192" height="3" rx="1" fill="#d8a877"/>
<rect x="12" y="756" width="192" height="16" fill="url(#france-drop)"/>
<ellipse cx="56" cy="747" rx="36" ry="6" fill="#191419" opacity="0.5"/>
...
<ellipse cx="130" cy="747" rx="30" ry="5" fill="#191419" opacity="0.45"/>
...
<!-- window 2: the apron on its hook, beside a hanging cloth -->
<rect x="232" y="686" width="120" height="5" rx="2" fill="#5a5260"/>
<path d="M252 691 q16 -6 30 2 l-5 52 q-11 4 -20 0 Z" fill="#cfd9dd" opacity="0.5"/>

<!-- window 3: the pâtisserie display — clock on the back wall, dome + lamp on a lit shelf -->
<g data-obj="wall-clock" transform="translate(452,700)">
...
<rect x="436" y="802" width="102" height="10" fill="url(#france-recess)"/>
<rect x="436" y="812" width="102" height="10" rx="3" fill="url(#france-wood2)"/>
<rect x="436" y="812" width="102" height="3" rx="1" fill="#f2d2ab"/>
<rect x="436" y="822" width="102" height="14" fill="url(#france-drop)"/>
<ellipse cx="472" cy="813" rx="28" ry="5" fill="#191419" opacity="0.45"/>
<g data-obj="cake-dome" transform="translate(444,761)">
...
<ellipse cx="521" cy="813" rx="20" ry="4" fill="#191419" opacity="0.45"/>
<g data-obj="oil-lamp" transform="translate(502,767)">
...
<!-- ============ ZONE 3b: the awning, and everything hung beneath it ============ -->
...
<rect x="30" y="668" width="494" height="30" fill="url(#france-drop)"/>
<!-- bunting cord along the awning lip, with pennant decoys either side -->
<path d="M36 662 Q276 676 516 664" fill="none" stroke="#8a5738" stroke-width="2"/>
<path d="M62 665 L74 667 L68 686 Z" fill="#c05f76"/>
<path d="M96 668 L108 670 L102 689 Z" fill="#e6c07c"/>
<path d="M130 670 L142 672 L136 691 Z" fill="#8fa9c4"/>
<path d="M420 673 L432 672 L426 691 Z" fill="#8fa9c4"/>
<path d="M456 671 L468 670 L462 689 Z" fill="#c05f76"/>
<path d="M492 669 L504 667 L498 686 Z" fill="#e6c07c"/>
<g data-obj="bunting" transform="translate(224,660)">
...
<!-- café sign on its wrought-iron bracket -->
<path d="M338 660 h64 M372 658 v6 M342 660 l8 -8" stroke="#3f3b46" stroke-width="3" fill="none"/>
<g data-obj="hang-sign" transform="translate(344,672)">
...
<!-- wind chime on a short cord off the awning lip -->
<path d="M428 660 v8" stroke="#8a5738" stroke-width="2" fill="none"/>
<g data-obj="wind-chime" transform="translate(412,668)">
...
<!-- ============ ZONE 5a: pavement, drawn in perspective toward the horizon ============ -->
<rect x="0" y="908" width="800" height="292" fill="url(#france-pave)"/>
<rect x="0" y="908" width="800" height="14" fill="#e9dfd0"/>
<path d="M-40 1010 L70 908 M140 1010 L205 908 M330 1010 L347 908 M520 1010 L468 908 M720 1010 L640 908" stroke="#bcab94" stroke-width="3" fill="none" opacity="0.42"/>
<path d="M0 922 L800 922 M0 956 L800 956 M0 1000 L800 1000" stroke="#bcab94" stroke-width="3" fill="none" opacity="0.5"/>
<rect x="0" y="908" width="800" height="26" fill="url(#france-drop)"/>

<!-- ============ ZONE 6a: the easel corner (palette + sheets share the tray) ============ -->
<ellipse cx="86" cy="1008" rx="96" ry="18" fill="url(#france-shadow)" opacity="0.55"/>
<ellipse cx="30" cy="1006" rx="16" ry="5" fill="url(#france-shadow-core)"/>
<ellipse cx="132" cy="1006" rx="16" ry="5" fill="url(#france-shadow-core)"/>
...
<circle cx="46" cy="798" r="9" fill="url(#france-sph-gold)"/>
<path d="M20 772 h112 v10 h-112 Z" fill="#ffffff" opacity="0.45"/>
<rect x="24" y="890" width="108" height="12" fill="url(#france-drop)"/>
<path d="M28 896 L128 896" stroke="#8a5738" stroke-width="10" fill="none"/>
<rect x="28" y="901" width="100" height="10" fill="url(#france-drop)"/>
<ellipse cx="52" cy="897" rx="30" ry="5" fill="url(#france-shadow-core)"/>
<g data-obj="artist-palette" transform="translate(18,840) scale(0.95)">
...
<ellipse cx="114" cy="897" rx="26" ry="5" fill="url(#france-shadow-core)"/>
<g data-obj="sheet-music" transform="translate(88,840)">
...
<!-- ============ ZONE 4b: the flower cart ============ -->
<ellipse cx="242" cy="946" rx="132" ry="22" fill="url(#france-shadow)" opacity="0.6"/>
...
<rect x="150" y="894" width="184" height="18" fill="url(#france-drop)"/>
<ellipse cx="186" cy="942" rx="26" ry="5" fill="url(#france-shadow-core)"/>
...
<ellipse cx="299" cy="942" rx="26" ry="5" fill="url(#france-shadow-core)"/>
...
<path d="M156 752 h52 v8 h-52 Z M280 754 h50 v8 h-50 Z" fill="#c0d2c8"/>
<path d="M172 748 q-8 -46 4 -70 M296 750 q-8 -44 2 -64 M310 750 q6 -40 -2 -56" stroke="#5f8a5e" stroke-width="4" fill="none"/>
<ellipse cx="184" cy="700" rx="42" ry="30" fill="url(#france-tree)"/>
<ellipse cx="306" cy="702" rx="38" ry="27" fill="url(#france-tree)"/>
<circle cx="176" cy="690" r="15" fill="url(#france-sph-rose)"/>
<circle cx="206" cy="678" r="13" fill="url(#france-sph-cream)"/>
<circle cx="164" cy="712" r="12" fill="url(#france-sph-purple)"/>
<circle cx="300" cy="690" r="14" fill="url(#france-sph-rose)"/>
<circle cx="318" cy="708" r="12" fill="url(#france-sph-purple)"/>
<circle cx="176" cy="690" r="6" fill="#f6d38f"/>
<circle cx="300" cy="690" r="6" fill="#f6d38f"/>
<!-- the scarf is thrown over the cart's top rail; butterfly and bee work the blooms -->
<ellipse cx="246" cy="792" rx="34" ry="7" fill="url(#france-shadow-core)" opacity="0.5"/>
<g data-obj="red-scarf" transform="translate(216,772)">
...
<g data-obj="butterfly" transform="translate(184,644)">
...
<g data-obj="honey-bee" transform="translate(268,652)">
...
<!-- ============ ZONE 5b: bistro table, chairs and the bread basket ============ -->
<ellipse cx="358" cy="952" rx="46" ry="12" fill="url(#france-shadow)" opacity="0.55"/>
<ellipse cx="356" cy="950" rx="22" ry="6" fill="url(#france-shadow-core)"/>
...
<!-- the waiter's apron is slung over the far chair back -->
<ellipse cx="432" cy="790" rx="24" ry="5" fill="#2b2833" opacity="0.35"/>
<g data-obj="apron" transform="translate(408,782)">
...
<ellipse cx="380" cy="950" rx="40" ry="10" fill="url(#france-shadow)" opacity="0.5"/>
<ellipse cx="374" cy="949" rx="22" ry="5" fill="url(#france-shadow-core)"/>
<g data-obj="handbag" transform="translate(348,896)">
...
<ellipse cx="362" cy="840" rx="48" ry="11" fill="url(#france-shadow-core)" opacity="0.45"/>
...
<!-- ============ ZONE 5c: lamppost, its hanging basket, and the pavement birds ============ -->
<ellipse cx="500" cy="950" rx="38" ry="12" fill="url(#france-shadow)" opacity="0.55"/>
<ellipse cx="494" cy="948" rx="22" ry="6" fill="url(#france-shadow-core)"/>
...
<path d="M531 692 v8" stroke="#2f2c36" stroke-width="3" fill="none"/>
<g data-obj="hang-basket" transform="translate(510,700)">
...
<ellipse cx="140" cy="994" rx="42" ry="10" fill="url(#france-shadow)" opacity="0.55"/>
<ellipse cx="132" cy="995" rx="22" ry="5" fill="url(#france-shadow-core)"/>
<g data-obj="grey-pigeon" transform="translate(100,950)">
...
<ellipse cx="196" cy="990" rx="26" ry="7" fill="url(#france-shadow)" opacity="0.45"/>
<path d="M172 980 a18 11 0 1 0 36 0 a18 11 0 1 0 -36 0 Z" fill="url(#france-copper)"/>
<circle cx="200" cy="970" r="8" fill="#dfae82"/>
<path d="M208 970 L217 972 L208 975 Z" fill="#5a3a26"/>
<path d="M176 976 q12 -5 24 2 q-10 7 -24 -2 Z" fill="#8a5738"/>
<ellipse cx="252" cy="980" rx="26" ry="6" fill="url(#france-shadow)" opacity="0.5"/>
<ellipse cx="248" cy="980" rx="14" ry="4" fill="url(#france-shadow-core)"/>
<g data-obj="snail" transform="translate(222,946)">
...
<!-- ============ ZONE 4c: the newsstand — recessed back plane, two lit shelves ============ -->
<ellipse cx="660" cy="944" rx="132" ry="20" fill="url(#france-shadow)" opacity="0.55"/>
<rect x="556" y="758" width="204" height="180" rx="6" fill="#3f5a4c"/>
<rect x="556" y="758" width="204" height="14" rx="5" fill="#66856f"/>
<rect x="566" y="772" width="184" height="150" fill="#233830"/>
<rect x="566" y="772" width="184" height="26" fill="url(#france-recess)"/>
<path d="M544 758 L772 758 L758 726 L562 726 Z" fill="url(#france-sage)"/>
<path d="M544 758 L772 758 L772 770 L544 770 Z" fill="#2f4539"/>
<path d="M562 726 L758 726 L754 716 L566 716 Z" fill="#83a390"/>
<path d="M560 672 h10 v58 h-10 Z M746 672 h10 v58 h-10 Z" fill="#3f5a4c"/>
<!-- shelf A: the flacon shelf -->
<rect x="562" y="846" width="192" height="11" rx="3" fill="url(#france-wood2)"/>
<rect x="562" y="846" width="192" height="3" rx="1" fill="#f2d2ab"/>
<rect x="566" y="857" width="184" height="16" fill="url(#france-recess)"/>
<rect x="574" y="800" width="26" height="46" rx="9" fill="url(#france-copper)"/>
<rect x="581" y="788" width="12" height="14" rx="3" fill="#8a5738"/>
<ellipse cx="626" cy="847" rx="30" ry="5" fill="#14201a" opacity="0.6"/>
<g data-obj="perfume-bottle" transform="translate(606,784)">
...
<rect x="666" y="794" width="28" height="52" rx="10" fill="url(#france-purple)"/>
<rect x="666" y="794" width="10" height="52" rx="5" fill="#d6c2ee"/>
<rect x="673" y="782" width="14" height="14" rx="3" fill="#8a5738"/>
<rect x="702" y="802" width="26" height="44" rx="9" fill="url(#france-green)"/>
<rect x="702" y="802" width="9" height="44" rx="4" fill="#a3c793"/>
<rect x="709" y="792" width="12" height="12" rx="3" fill="#e3dcd2"/>
<!-- shelf B: the curio shelf -->
<rect x="562" y="904" width="192" height="11" rx="3" fill="url(#france-wood2)"/>
<rect x="562" y="904" width="192" height="3" rx="1" fill="#f2d2ab"/>
<rect x="566" y="915" width="184" height="14" fill="url(#france-recess)"/>
<ellipse cx="618" cy="905" rx="32" ry="5" fill="#14201a" opacity="0.6"/>
<g data-obj="film-camera" transform="translate(586,864)">
...
<ellipse cx="682" cy="905" rx="30" ry="5" fill="#14201a" opacity="0.6"/>
<g data-obj="folded-map" transform="translate(654,860)">
...
<path d="M714 866 h34 v38 h-34 Z" fill="url(#france-red)"/>
<path d="M714 866 h34 v8 h-34 Z" fill="#b44a63"/>
<path d="M578 924 h64 v10 h-64 Z M654 926 h58 v10 h-58 Z" fill="url(#france-blue)"/>
<!-- chalkboard leaning on the pavement in front of the kiosk -->
<ellipse cx="562" cy="990" rx="60" ry="14" fill="url(#france-shadow)" opacity="0.55"/>
<ellipse cx="540" cy="988" rx="18" ry="5" fill="url(#france-shadow-core)"/>
<ellipse cx="584" cy="988" rx="18" ry="5" fill="url(#france-shadow-core)"/>
<path d="M528 930 L538 986 M580 930 L574 986" stroke="url(#france-wood)" stroke-width="6" fill="none"/>
<g data-obj="chalk-menu" transform="translate(520,858)">
...
<path d="M-20 1046 Q400 964 820 1046" fill="none" stroke="#ddd2c2" stroke-width="4" opacity="0.55"/>

<!-- vignette 1: the paint corner, straight below the easel -->
<ellipse cx="40" cy="1112" rx="52" ry="14" fill="url(#france-shadow)" opacity="0.5"/>
<ellipse cx="34" cy="1109" rx="26" ry="6" fill="url(#france-shadow-core)"/>
<g data-obj="brush-jar" transform="translate(6,1042)">
...
<path d="M18 1046 L12 1000 M29 1046 L29 990 M40 1046 L48 996" stroke="url(#france-wood2)" stroke-width="7" stroke-linecap="round" fill="none"/>
<path d="M10 1002 L14 986 L18 1002 Z" fill="#7b4fb5"/>
<path d="M25 992 L29 976 L33 992 Z" fill="#e88aa2"/>
<path d="M44 998 L50 982 L52 1000 Z" fill="#4a6b8a"/>
<ellipse cx="112" cy="1190" rx="46" ry="12" fill="url(#france-shadow)" opacity="0.45"/>
<path d="M82 1188 q-2 -16 15 -22 q17 -7 31 -1 q14 7 12 19 q-2 14 -17 20 L84 1200 Z" fill="url(#france-wood)"/>
<circle cx="98" cy="1180" r="6" fill="#4a6b8a"/>
<circle cx="116" cy="1176" r="6" fill="#f3a6b8"/>

<!-- vignette 2: the flower vase — the lightstick stands among the lavender -->
<ellipse cx="104" cy="1164" rx="52" ry="14" fill="url(#france-shadow)" opacity="0.5"/>
<ellipse cx="100" cy="1160" rx="26" ry="6" fill="url(#france-shadow-core)"/>
<path d="M96 1064 q-10 -48 -18 -76 M108 1064 q4 -52 14 -80 M120 1066 q14 -40 32 -60 M86 1066 q-16 -34 -36 -50" stroke="#5f8a5e" stroke-width="5" fill="none" stroke-linecap="round"/>
<path d="M74 1006 q-16 -8 -24 -2 q11 11 24 6 Z M126 1002 q15 -10 24 -4 q-11 12 -24 8 Z" fill="url(#france-green)"/>
...
<!-- vignette 3: the coffee setting -->
<ellipse cx="266" cy="1058" rx="98" ry="24" fill="url(#france-shadow)" opacity="0.45"/>
<ellipse cx="262" cy="1052" rx="72" ry="14" fill="url(#france-shadow-core)" opacity="0.75"/>
...
<ellipse cx="392" cy="1078" rx="36" ry="11" fill="url(#france-shadow)" opacity="0.4"/>
<ellipse cx="392" cy="1074" rx="22" ry="6" fill="url(#france-shadow-core)"/>
...
<!-- vignette 4: the stack of books, purple heart on the cover -->
<ellipse cx="258" cy="1196" rx="122" ry="16" fill="url(#france-shadow)" opacity="0.4"/>
<ellipse cx="252" cy="1192" rx="90" ry="9" fill="url(#france-shadow-core)" opacity="0.7"/>
...
<ellipse cx="256" cy="1150" rx="34" ry="7" fill="#2c1c3c" opacity="0.45"/>
...
<!-- vignette 5: the tiered pastry stand -->
<ellipse cx="470" cy="1140" rx="78" ry="20" fill="url(#france-shadow)" opacity="0.5"/>
<ellipse cx="466" cy="1136" rx="50" ry="10" fill="url(#france-shadow-core)" opacity="0.7"/>
...
<ellipse cx="470" cy="1032" rx="76" ry="14" fill="url(#france-shadow)" opacity="0.3"/>
<ellipse cx="470" cy="944" rx="42" ry="9" fill="url(#france-shadow-core)" opacity="0.5"/>
...
<!-- vignette 6: the glass pastry case — the croissant among its cousins -->
<ellipse cx="628" cy="1144" rx="100" ry="24" fill="url(#france-shadow)" opacity="0.45"/>
<ellipse cx="624" cy="1140" rx="76" ry="10" fill="url(#france-shadow-core)" opacity="0.6"/>
...
<rect x="550" y="1002" width="148" height="14" fill="url(#france-drop)"/>
<ellipse cx="586" cy="1044" rx="24" ry="5" fill="url(#france-shadow-core)" opacity="0.5"/>
<circle cx="578" cy="1030" r="17" fill="url(#france-pastry)"/>
<circle cx="578" cy="1015" r="8" fill="#f9dba7"/>
<ellipse cx="616" cy="1045" rx="40" ry="6" fill="url(#france-shadow-core)" opacity="0.5"/>
...
<rect x="550" y="1055" width="148" height="12" fill="url(#france-drop)"/>
<ellipse cx="588" cy="1096" rx="38" ry="7" fill="url(#france-shadow-core)" opacity="0.45"/>
...
<rect x="634" y="1066" width="46" height="32" rx="5" fill="url(#france-pastry)"/>
<rect x="634" y="1066" width="46" height="9" rx="4" fill="#f3cf95"/>
<path d="M645 1066 v32 M669 1066 v32" stroke="#5a3a26" stroke-width="5" fill="none"/>
...
<!-- vignette 7: the shopping bags, with the wax cheese propped against them -->
<ellipse cx="752" cy="1140" rx="86" ry="22" fill="url(#france-shadow)" opacity="0.45"/>
<ellipse cx="748" cy="1136" rx="58" ry="9" fill="url(#france-shadow-core)" opacity="0.6"/>
...
<ellipse cx="758" cy="1090" rx="34" ry="8" fill="url(#france-shadow-core)" opacity="0.5"/>
...
<!-- vignette 8: the writing set on an open notebook -->
<ellipse cx="452" cy="1194" rx="76" ry="14" fill="url(#france-shadow)" opacity="0.4"/>
<path d="M386 1152 q66 -12 128 0 l-4 44 q-62 10 -120 0 Z" fill="url(#france-cream)"/>
<path d="M386 1152 q66 -12 128 0 l-1 8 q-63 -11 -126 0 Z" fill="#fffcf5"/>
<path d="M450 1150 v46" stroke="#dbcbb2" stroke-width="2" fill="none"/>
<ellipse cx="424" cy="1186" rx="30" ry="5" fill="url(#france-shadow-core)" opacity="0.45"/>
<g data-obj="fountain-pen" transform="translate(398,1160)">
...
<ellipse cx="478" cy="1186" rx="28" ry="5" fill="url(#france-shadow-core)" opacity="0.45"/>
<g data-obj="train-ticket" transform="translate(452,1158)">
...
<!-- vignette 9: the keepsake dish -->
<ellipse cx="612" cy="1196" rx="66" ry="14" fill="url(#france-shadow)" opacity="0.4"/>
<ellipse cx="612" cy="1188" rx="62" ry="16" fill="#e2d6c2"/>
<ellipse cx="612" cy="1184" rx="62" ry="16" fill="url(#france-porcelain)"/>
<ellipse cx="612" cy="1183" rx="48" ry="11" fill="#eee4d4"/>
<ellipse cx="596" cy="1192" rx="26" ry="6" fill="url(#france-shadow-core)" opacity="0.5"/>
<g data-obj="pocket-watch" transform="translate(572,1146)">
...
<ellipse cx="646" cy="1188" rx="28" ry="5" fill="url(#france-shadow-core)" opacity="0.45"/>
<g data-obj="brass-key" transform="translate(620,1168)">
